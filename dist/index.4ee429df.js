...
},{}],"4D4d3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const validateEmail = ()=>{
    ...
    const checkInput = ()=>{
        ...
        if (emailValue === '') setErrorMsg(emailInput, 'Email cannot be blank');
        else if (!isEmail(emailValue)) setErrorMsg(emailInput, 'Email is not valid');
